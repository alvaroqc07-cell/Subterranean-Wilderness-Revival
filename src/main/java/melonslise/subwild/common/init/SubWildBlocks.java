...
public final class SubWildBlocks
{
	public static final DeferredRegister<Block> BLOCKS =
		DeferredRegister.create(ForgeRegistries.BLOCKS, SubWild.ID);

	public static final RegistryObject<Block>
		DIRT_STAIRS = add("dirt_stairs", new StairBlock(Blocks.DIRT::defaultBlockState, Block.Properties.copy(Blocks.DIRT).strength(0.5F).sound(SoundType.GRASS))),
		DIRT_SLAB   = add("dirt_slab",   new SlabBlock(Block.Properties.copy(Blocks.DIRT).strength(0.5F).sound(SoundType.GRASS))),

		SHORT_FOXFIRE = add("short_foxfire", new FoxfireBlock(Block.Properties.of().noCollission().strength(0f).sound(SoundType.NETHER_WART))),
		LONG_FOXFIRE  = add("long_foxfire",  new FoxfireBlock(Block.Properties.of().noCollission().strength(0f).sound(SoundType.NETHER_WART))),

		LIGHT_BROWN_ROOTS  = add("light_brown_roots",  new RootsBlock(Block.Properties.of().noCollission().strength(0.1f).sound(SoundType.NETHER_WART))),
		BROWN_ROOTS        = add("brown_roots",        new RootsBlock(Block.Properties.of().noCollission().strength(0.1f).sound(SoundType.NETHER_WART))),
		WHITE_ROOTS        = add("white_roots",        new RootsBlock(Block.Properties.of().noCollission().strength(0.1f).sound(SoundType.NETHER_WART))),
		LIGHT_ORANGE_ROOTS = add("light_orange_roots", new RootsBlock(Block.Properties.of().noCollission().strength(0.1f).sound(SoundType.NETHER_WART))),
		DARK_BROWN_ROOTS   = add("dark_brown_roots",   new RootsBlock(Block.Properties.of().noCollission().strength(0.1f).sound(SoundType.NETHER_WART))),
		ORANGE_ROOTS       = add("orange_roots",       new RootsBlock(Block.Properties.of().noCollission().strength(0.1f).sound(SoundType.NETHER_WART))),

		DIRT_PATCH       = add("dirt_patch",       new PatchBlock(Block.Properties.of().strength(0.1f).sound(SoundType.GRAVEL).requiresCorrectToolForDrops())),
		MOSSY_DIRT_PATCH = add("mossy_dirt_patch", new PatchBlock(Block.Properties.of().strength(0.1f).sound(SoundType.WET_GRASS).requiresCorrectToolForDrops())),
		PODZOL_PATCH     = add("podzol_patch",     new PatchBlock(Block.Properties.of().strength(0.1f).sound(SoundType.GRAVEL).requiresCorrectToolForDrops())),
		GRAVEL_PATCH     = add("gravel_patch",     new PatchBlock(Block.Properties.of().strength(0.15f).sound(SoundType.GRAVEL).requiresCorrectToolForDrops())),
		SAND_PATCH       = add("sand_patch",       new PatchBlock(Block.Properties.of().strength(0.1f).sound(SoundType.SAND).requiresCorrectToolForDrops())),
		RED_SAND_PATCH   = add("red_sand_patch",   new PatchBlock(Block.Properties.of().strength(0.1f).sound(SoundType.SAND).requiresCorrectToolForDrops())),
		SNOW_PATCH       = add("snow_patch",       new PatchBlock(Block.Properties.of().randomTicks().strength(0.1f).sound(SoundType.SNOW).requiresCorrectToolForDrops())),
		ICE_PATCH        = add("ice_patch",        new MeltingPatchBlock(Block.Properties.of().friction(0.98f).strength(0.1f).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops())),
		WATER_PUDDLE     = add("water_puddle",     new PuddleBlock(Block.Properties.of().noCollission().strength(0f).noLootTable().sound(SubWildSoundTypes.WATER))),
		...
		FROZEN_STONE_SPELEOTHEM        = add("frozen_stone_speleothem",        new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), STONE_SPELEOTHEM)),
		FROZEN_GRANITE_SPELEOTHEM      = add("frozen_granite_speleothem",      new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), GRANITE_SPELEOTHEM)),
		FROZEN_DIORITE_SPELEOTHEM      = add("frozen_diorite_speleothem",      new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), DIORITE_SPELEOTHEM)),
		FROZEN_ANDESITE_SPELEOTHEM     = add("frozen_andesite_speleothem",     new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), ANDESITE_SPELEOTHEM)),
		FROZEN_SANDSTONE_SPELEOTHEM    = add("frozen_sandstone_speleothem",    new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), SANDSTONE_SPELEOTHEM)),
		FROZEN_RED_SANDSTONE_SPELEOTHEM = add("frozen_red_sandstone_speleothem", new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), RED_SANDSTONE_SPELEOTHEM)),
		FROZEN_OBSIDIAN_SPELEOTHEM     = add("frozen_obsidian_speleothem",     new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), OBSIDIAN_SPELEOTHEM)),
		FROZEN_BLACKSTONE_SPELEOTHEM   = add("frozen_blackstone_speleothem",   new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), BLACKSTONE_SPELEOTHEM)),
		FROZEN_BASALT_SPELEOTHEM       = add("frozen_basalt_speleothem",       new EncasedSpeleothemBlock(Block.Properties.of().friction(0.98f).strength(0.5f).sound(SoundType.GLASS).noOcclusion(), BASALT_SPELEOTHEM)),
		...
		MOSSY_STONE             = add("mossy_stone",             new Block(Block.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F))),
		...
		SANDSTONE_IRON_ORE     = add("sandstone_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		SANDSTONE_GOLD_ORE     = add("sandstone_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		...
		SMOOTH_SANDSTONE_IRON_ORE     = add("smooth_sandstone_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		SMOOTH_SANDSTONE_GOLD_ORE     = add("smooth_sandstone_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		...
		RED_SANDSTONE_IRON_ORE     = add("red_sandstone_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.RED_SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		RED_SANDSTONE_GOLD_ORE     = add("red_sandstone_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.RED_SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		...
		SMOOTH_RED_SANDSTONE_IRON_ORE     = add("smooth_red_sandstone_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.SMOOTH_RED_SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		SMOOTH_RED_SANDSTONE_GOLD_ORE     = add("smooth_red_sandstone_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.SMOOTH_RED_SANDSTONE).strength(1.6f), UniformInt.of(0,0))),
		...
		TERRACOTTA_IRON_ORE     = add("terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		TERRACOTTA_GOLD_ORE     = add("terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		WHITE_TERRACOTTA_IRON_ORE     = add("white_terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.WHITE_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		WHITE_TERRACOTTA_GOLD_ORE     = add("white_terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.WHITE_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		ORANGE_TERRACOTTA_IRON_ORE     = add("orange_terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.ORANGE_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		ORANGE_TERRACOTTA_GOLD_ORE     = add("orange_terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.ORANGE_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		YELLOW_TERRACOTTA_IRON_ORE     = add("yellow_terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.YELLOW_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		YELLOW_TERRACOTTA_GOLD_ORE     = add("yellow_terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.YELLOW_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		LIGHT_GRAY_TERRACOTTA_IRON_ORE     = add("light_gray_terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		LIGHT_GRAY_TERRACOTTA_GOLD_ORE     = add("light_gray_terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		BROWN_TERRACOTTA_IRON_ORE     = add("brown_terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.BROWN_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		BROWN_TERRACOTTA_GOLD_ORE     = add("brown_terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.BROWN_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		RED_TERRACOTTA_IRON_ORE     = add("red_terracotta_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.RED_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		RED_TERRACOTTA_GOLD_ORE     = add("red_terracotta_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.RED_TERRACOTTA).strength(2.5f), UniformInt.of(0,0))),
		...
		// Ice ores
		ICE_COAL_ORE     = add("ice_coal_ore",     new XpBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops(), 0, 2)),
		ICE_IRON_ORE     = add("ice_iron_ore",     new EncasedOreBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops())),
		ICE_GOLD_ORE     = add("ice_gold_ore",     new EncasedOreBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops())),
		ICE_LAPIS_ORE    = add("ice_lapis_ore",    new XpBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops(), 2, 5)),
		ICE_REDSTONE_ORE = add("ice_redstone_ore", new XpBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops(), 1, 6)),
		ICE_DIAMOND_ORE  = add("ice_diamond_ore",  new XpBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops(), 3, 7)),
		ICE_EMERALD_ORE  = add("ice_emerald_ore",  new XpBlock(Block.Properties.of().strength(1f).friction(0.98F).noOcclusion().sound(SoundType.GLASS).requiresCorrectToolForDrops(), 3, 7)),

		// Blackstone ores
		BLACKSTONE_COAL_ORE     = add("blackstone_coal_ore",     new XpBlock(Block.Properties.copy(Blocks.BLACKSTONE).strength(3f), 0, 2)),
		BLACKSTONE_IRON_ORE     = add("blackstone_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.BLACKSTONE).strength(3f), UniformInt.of(0,0))),
		BLACKSTONE_GOLD_ORE     = add("blackstone_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.BLACKSTONE).strength(3f), UniformInt.of(0,0))),
		...
		BASALT_IRON_ORE     = add("basalt_iron_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.BASALT).strength(2.5f), UniformInt.of(0,0))),
		BASALT_GOLD_ORE     = add("basalt_gold_ore",     new DropExperienceBlock(Block.Properties.copy(Blocks.BASALT).strength(2.5f), UniformInt.of(0,0))),
	...
	{
		SubWildItems.add(name, new BlockItem(block, new Item.Properties()));
